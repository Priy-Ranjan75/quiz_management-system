...
public class InstructionStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 28, 76, -1));

        jLabel2.setFont(new java.awt.Font("Arial", 3, 36)); // NOI18N
        jLabel2.setText("Instructions");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(102, 36, 229, -1));

        jTextArea1.setColumns(20);
        jTextArea1.setFont(new java.awt.Font("Arial", 3, 18)); // NOI18N
        jTextArea1.setRows(5);
        jTextArea1.setText("During the exam:\n\n1:The student may not use his or her textbook,course notes or recieve help from a proctor\n   or any other outside source.\n\n2:Students must compelete the 10-question multiple-choice exam within the 10-minute\n   time frame alloted for the exam.\n\n3:Students must not stop the session and then return to it.This is specially important\n   in the online environment where the  system will \"time-out\" and not allow the student \n   or you to reenter the exam.\n\nNumber of Question : 10\nExam duration time : 10 min\nAll the best\n");
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, 841, 397));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 520, 250, 60));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            setVisible(false);
            new QUIZExamStudentPage(rollno).setVisible(true);
        } catch (Exception e) {
